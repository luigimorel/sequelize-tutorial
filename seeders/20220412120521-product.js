      ...
      [
        {
          ...
          // Store the price in cents e.g if price is $5, multiply by 100 cents i.e 5 * 100 = 500 cents
          price: 500,
          expiryDate: new Date(),
          createdAt: new Date(),
          updatedAt: new Date()
        },
        {
          ...
          // Store the price in cents e.g if the price is $5, multiply by 100 cents i.e 5 * 100 = 500 cents
          price: 100,
          expiryDate: new Date(),
          createdAt: new Date(),
          updatedAt: new Date()
